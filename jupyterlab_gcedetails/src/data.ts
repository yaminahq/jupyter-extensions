...
export function getGpuCountOptionsList(
  ...
  const accelerator = accelerators.find(
    accelerator => accelerator.name === acceleratorName
  );
  return ACCELERATOR_COUNTS_1_2_4_8.slice(
    0,
